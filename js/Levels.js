...
export function loadLevel(state, levelId) {
  ...
  state.level = {
    ...
    autoFeederUnlockPurchased: false, // "Tier 2.5" — the $5000 step (after the real Tier 1->2 crack, before the real Tier 2->3 crack) that grants ONLY the Auto-Feeder — see Config.js's AUTO_FEEDER_UNLOCK_COST
