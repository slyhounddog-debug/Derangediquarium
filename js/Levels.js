...
export function loadLevel(state, levelId) {
  ...
  state.level = {
    ...
    // Power is NOT a battery — Eels generate MW that has to be used the
    ...
    powerGenAccumMw: 0, // MW generated by GENERATOR fish so far THIS in-progress real second — see Entities.js's updateFish GENERATOR branch. Read and reset to 0 once per real second by main.js's update()
